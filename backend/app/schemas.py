...
class DeliveryChannelState(BaseModel):
    to: str | None = None
    status: str = "not_sent"
...
class DeliveryArtifact(BaseModel):
    letter_url: str = ""
    email: DeliveryChannelState = Field(default_factory=DeliveryChannelState)
...
class PipelineResponse(BaseModel):
    ...
    delivery: DeliveryArtifact = Field(default_factory=DeliveryArtifact)
    audio_script: str
    print_status: str
